  ...
  return (
    <div className="container-fluid" style={{ height: "100vh" ,overflowY:"hidden"}}>
      <div className="row h-100">
        ...
        <div className={`${withoutSidebar.includes(location.pathname)?"col-12":"col-lg-10 col-md-10 col-sm-12 p-0 h-100 example"}`} style={{height:"100%",overflowY:"auto",background:"#FAFBFF"}} >
          <AllRoutes/>
        </div>
      </div>
    </div>
